...
import com.solvd.administraion.*;
import com.solvd.course.Course;
import com.solvd.course.CourseLevel;
import com.solvd.course.CourseStatus;
import com.solvd.course.Faculty;
import com.solvd.exam.ExamSession;
import com.solvd.exam.FinalExam;
import com.solvd.exam.Result;
...
import com.solvd.room.ExamRoom;
import com.solvd.student.Student;
import com.solvd.university.Address;
...
IntStream.range(0, 5)
    ...
    .forEach(student -> {
        ...
        System.out.println(studentService.getStudentsNameOnCourse(math, administration).stream().
                flatMap(studentName -> studentName.chars().mapToObj(c -> (char) c)).
                toList());
