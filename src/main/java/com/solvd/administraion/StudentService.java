...
import com.solvd.exception.InvalidRegistrationException;
import com.solvd.exception.RegistrationLimitException;
...
public class StudentService implements Printable, Reportable<Student> {
    ...
    public Map<Integer, List<Student>> groupStudentsByAGe(Administration administration) {
        return administration.getStudentRepository().getAll().stream().collect(Collectors.groupingBy(Person::getAge));
    }
}
